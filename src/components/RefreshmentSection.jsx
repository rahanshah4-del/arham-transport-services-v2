    ...
    <section id="refreshment" className="section-wrap py-20 lg:py-24">
      <div className="section-container">
        ...
        >
          ...
          <h2 className="mt-4 font-heading text-3xl font-extrabold text-[#FFFFFF] sm:text-4xl">
            Premium Ride Refreshment Options
          </h2>
          <p className="mt-3 max-w-4xl text-sm leading-relaxed text-[#C7D2FE] sm:text-base">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <div className="glass-soft flex items-center gap-2 text-sm font-semibold text-[#FFFFFF]">
              <CupSoda size={18} className="text-[#F5B841]" />
              With Refreshment: +2000 PKR
            </div>
            <div className="glass-soft flex items-center gap-2 text-sm font-semibold text-[#FFFFFF]">
              <Sparkles size={18} className="text-[#F5B841]" />
